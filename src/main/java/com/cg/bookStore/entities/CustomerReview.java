...
public class CustomerReview {
	...
	public CustomerReview(int ratingId, @Min(1) @Max(2) int bookRating,
			@Size(min = 20, max = 128) String reviewHeadling, @Size(min = 100, max = 300) String reviewComment) {
		super();
